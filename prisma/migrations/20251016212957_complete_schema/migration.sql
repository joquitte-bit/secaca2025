...
CREATE TABLE "report_snapshots" (
    ...
    "json" TEXT NOT NULL,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "report_snapshots_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "organizations" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "quiz_questions_lessonId_order_idx" ON "quiz_questions"("lessonId", "order");
...
-- CreateIndex
CREATE INDEX "report_snapshots_orgId_idx" ON "report_snapshots"("orgId");
